...
/*
 $Id: onlinesql.php 337 2006-07-21 21:33:16Z sgrayban $
...
$uo_sqluser = "sgrayban";     //mysql username
$uo_sqlpass = "dannyboy";     //mysql password
$uo_sqlhost = "dev.borgforge.net";    //mysql host
$uo_sqlbase = "users_online"; //mysql database
