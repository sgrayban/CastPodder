#! python
# -*- coding: utf-8 -*-
# $Id: sv.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_donate", u"Donera till CastPodder")
    add("str_donate_expl", u"Det är viktigt att hålla gemenskapsägda CastPodder-applikationer online och behålla detta nya sätt att konsumera fri media. Donerade pengar håller vårat team glatt och sporrar oss att jobba på nya funktioner och tjänster.")
    ...
    add("str_ep_to_download", u"Väntar på nedladdning")
    ...
    add("str_gen_options_expl", u"Ändra allmäna inställningar för CastPodderapplikationer.")
    add("str_hide_on_startup", u"Visa CastPodder endast i meddelandefältet vid uppstart.")
    ...
    import gui.skin
    add("str_ipodder_title", gui.skin.PRODUCT_NAME + u" - Podradiomottagare v" + __version__)
    ...
    # check for update
    add("str_new_version_ipodder", u"En ny version av CastPodder finns tillgänglig - tryck Ok för att gå till sajten.")
    add("str_no_new_version_ipodder", u"Du har den senaste versionen")
    add("str_other_copy_running", u"En annan instans av CastPodder körs. Var vänlig avsluta den först.")

    # Windows taskbar right-click menu
    add("str_check_now", u"Kontrollera nu")        
    add("str_open_ipodder", u"Öppna CastPodder")
    #--- Downloading
