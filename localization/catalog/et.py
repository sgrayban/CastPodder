#! python
# -*- coding: utf-8 -*-
# $Id: et.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_goto_background_on_close_warn", \
        u"CastPodder võib jätkata tegevust tagaplaanil pärast peaakna \n" \
        u"sulgemist.  Või võib CastPodder lõpetada tegevuse.  Kas sa sooviksid et CastPodder jätkaks \n" \
        u"tegevust?")
    ...
    add("str_initialized", u"CastPodder on töökorras")
    ...
    add("str_localization_restart", u"Et uut keelt kasutada, sulgeb CastPodder ennast ning sa pead selle uuesti avama. Kliki OK et sulgeda, cancel et jätkata praegust keelt kasutades.")
    ...
    add("str_open_ipodder", u"Ava CastPodder")
    #--- Downloading
