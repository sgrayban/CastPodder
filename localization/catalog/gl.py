#! python
# -*- coding: utf-8 -*-
# $Id: gl.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
   ...
   add("str_donate", u"Donativo a CastPodder")
   add("str_donate_expl", u"É importante preservar o esprito comunitario, aberto e público de CastPodder e mante-lo xeito de acceso a este novo medio de comunicación ceibe. Calquera cantidade de diñeiro aledará á equipa de desenrolo e animaraos a traballar en novas prestacións e servizos!")
   ...
   add("str_ep_to_download", u"Para descargar")
   ...
   add("str_gen_options_expl", u"Establece as opcións xerais de CastPodder")
   add("str_hide_on_startup", u"Ao iniciar amosar CastPodder unicamente na Bandexa do Sistema")
   ...
   ## Donations Dialog
   #--- Donativo a CastPodder
   #--- É importante preservar o esprito comunitario, aberto e público de CastPodder e mante-lo xeito de acceso a este novo medio de comunicación ceibe. Calquera cantidade de diñeiro aledará á equipa de desenrolo e animaraos a traballar en novas prestacións e servizos!
   ...
   add("str_initialized", u"CastPodder listo")

   ## Other application strings
   from ipodder.configuration import __version__
   import gui.skin
   add("str_ipodder_title", gui.skin.PRODUCT_NAME + u" - Receptor Podcast v" + __version__)
   add("str_localization_restart", u"Para localizar tódolos controis de CastPodder é preciso que reinicies. Preme Ok para reiniciar ou Cancelar para continuar.")
   add("str_really_quit", u"Descarga en marcha. Queres saír?");
   add("str_double_check", u"Semella que aínda hai unha descarga en marcha.");

   # check for update
   add("str_new_version_ipodder", u"Está dispoñible unha nova versión de CastPodder, preme Ok para visitar a páxina de descargas.")
   add("str_no_new_version_ipodder", u"Esta versión de CastPodder está ao día")
   add("str_other_copy_running", u"Outra copia de CastPodder está en execución. Por favor, actívaa, agarda a que remate ou péchaa.")

   # Windows taskbar right-click menu
   add("str_check_now", u"Revisar agora")
   add("str_open_ipodder", u"Abrir CastPodder")
   #--- Downloading
