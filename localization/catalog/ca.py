...
# $Id: ca.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_donate", u"Fer una donació a CastPodder")
    add("str_donate_expl", u"Es important mantenir en linea les aplicacions CastPodder de la comunitat i mantenir aquest modus de consumir mitjans gratuits. Qualsevol quantitat de diners encoratjarà al equip a treballar en noves prestacions i serveis!")
    ...
    add("str_ep_to_download", u"A Descarregar")
    ...
    add("str_gen_options_expl", u"Configuració de les opcions generals del CastPodder")
    ...
    #--- Es important mantenir aplicacions no comercials d'CastPodder en linea i mantenir aquesta manera de consumir mitjans gratuits. Qualsevol quantitat de diners farà feliç els membres del equip i els encoratjarà a ampliar-ne les posibilitats!
    ...
    add("str_initialized", u"CastPodder inicialitzat")
    ...
    import gui.skin
    add("str_ipodder_title", gui.skin.PRODUCT_NAME + u" - Descarregador de Podcasts v" + __version__)
