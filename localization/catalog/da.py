#! python
# -*- coding: utf-8 -*-
# $Id: da.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_goto_background_on_close_warn", \
        u"CastPodder kan fortsætte med at køre i baggrunden efter hovedvinduet \n" \
        u"er lukket. Eller CastPodder kan afslutte.  Vil du have at CastPodder skal \n" \
        u"fortsætte med at køre?")
    ...
    add("str_set_catchup_description", \
        u"Når der tjekkes i indhentningstilstand, vil CastPodder springe alle andre \n" \
        u"punkter end det øverste i hver kanal over. Angiv hvordan CastPodder skal behandle \n" \
        u"de oversprungne punkter.")
    ...
    add("str_set_oneclick_handler_warn",\
        u"CastPodder er ikke p.t. din et-kliks-håndtering for podcasts. \n" \
        u"Skal vi indstille CastPodder til at starte ved klik på en abonnements-henvisning?")
    add("str_ensure_oneclick_handler", u"Benyt altid CastPodder til et-kliks-abonnement")
    ...
    add("str_donate", u"Donér til CastPodder")
    add("str_donate_expl", u"Det er vigtigt at beholde almenhedens CastPodder-programmer på nettet og bevare denne friheden for denne nye måde at bruge medier på. Ethvert pengebeløb vil glæde udviklerne og tilskynde dem til at arbejde på nye funktioner og services!")
    ...
    add("str_ep_to_download", u"Skal hentes")
    ...
    add("str_gen_options_expl", u"Sæt CastPodder-programmets generelle indstillinger")
    add("str_hide_on_startup", u"Vis kun CastPodder i systempanelet ved opstart")
    ...
    add("str_initialized", u"CastPodder klar")
    ...
    import gui.skin
    add("str_ipodder_title", gui.skin.PRODUCT_NAME + " - Podcast-modtager v" + __version__)
    add("str_localization_restart", u"For at oversætte alle CastPodders knapper, skal CastPodder genstartes. Tryk O.k. for at lukke ned, eller afbryd for at fortsætte.")
    ...
    # check for update
    add("str_new_version_ipodder", u"Der er kommet en ny version af CastPodder. Tryk O.k. for at gå til den side, hvorfra den kan hentes.")
    add("str_no_new_version_ipodder", u"Denne version af CastPodder behøver ingen opdatering")
    add("str_other_copy_running", u"Der kører en anden kopi af CastPodder. Hent den frem, vent til den er afsluttet, eller dræb den.")

    # Windows taskbar right-click menu
    add("str_check_now", u"Tjek nu")        
    add("str_open_ipodder", u"Åbn CastPodder")
    #--- Downloading
