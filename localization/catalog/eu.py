#! python
# -*- coding: utf-8 -*-
# $Id: eu.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_goto_background_on_close_warn", \
        u"CastPodder atzeko planoan lan egiten jarraitu dezake, nahiz eta leiho nagusia itxi . \n" \
        u" Edo CastPodderretik atera zaitezke.  CastPodder martxan jarraitzea  \n" \
        u"nahi duzu?")
    ...
    add("str_set_catchup_description", \
        ...
        u"jario bakoitzan goian dauenak dira.  Mesedez, zehaztu ezazu CastPodderrek nola kudeatu behar dituen\n" \
        u"kontutan hartu ez diren elementuak.")
    ...
    add("str_set_oneclick_handler_warn",\
        u"CastPodder ez da klik-bakarreko podcast harpidetze maneiatzailea. \n" \
        u"Klik-bakarreko harpidetza loturak kudeatzeko CastPodder erabili nahi duzu??")
    ...
    add("str_donate", u"CastPodder-i dohaintza bat egin")
    ...
    add("str_ep_to_download", u"Jaisteko")
    ...
    add("str_gen_options_expl", u"CastPodder aplikazioarentzat aukera orokorrak")
    add("str_hide_on_startup", u"Hasieran CastPodder system tray-ean bakarrik erakutsi")
    ...
    add("str_initialized", u"CastPodder prest")
    ...
    import gui.skin
    add("str_ipodder_title", gui.skin.PRODUCT_NAME + " - Podcast irakurgailua v" + __version__)
    add("str_localization_restart", u"CastPodderren kontrol guztiak lokalizatzeko berabiatzea beharrezkoa da. OK sakatu ondo ixteko, edo ezeztatu jarraitzeko.")
    ...
    # check for update
    add("str_new_version_ipodder", u"CastPodder bertsio berri bat dagoela dirudi, jaisteko gunera joan OK zapalduz")
    add("str_no_new_version_ipodder", u"CastPodder bertsio hau eguneraturik dago")
    add("str_other_copy_running", u"CastPodder beste bertsio bat martxan dago. Esnatu ezazu, itxaron amaitzea, edo hil ezazu.")

    # Windows taskbar right-click menu
    add("str_check_now", u"Egiaztatu orain")        
    add("str_open_ipodder", u"CastPodder ireki")
    #--- Downloading
