#! python
# -*- coding: utf-8 -*-
# $Id: el.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_goto_background_on_close_warn", \
        u"Το CastPodder μπορεί να συνεχίσει διακριτικά την λειτουργία του μετά το κλείσιμο. \n" \
        u"Διαφορετικά μπορεί να τερματίσει την λειτουργία του.  Θα θέλατε το CastPodder \n" \
        u"να εξακολουθήσει να λειτουργεί;")
    ...
    add("str_set_catchup_description", \
        u"Όταν ελέγχει σε κατάσταση Αναπλήρωσης, το CastPodder προσπερνά όλα εκτός από τα πιο πρόσφατα \n" \
        u"στοιχεία σε κάθε Feed. Παρακαλώ, διαλέξτε τι να κάνει το CastPodder με τα \n" \
        u"προσπερασμένα στοιχεία.")
    ...
    add("str_set_oneclick_handler_warn",\
        u"Το CastPodder αυτή την στιγμή δεν έχει ρυθμιστεί να αναλαμβάνει Άμεσες Συνδρομές (με ένα κλίκ) σε Podcasts. \n" \
        u"Θέλετε να ρυθμιστεί το CastPodder να ξεκινά όταν κάνετε κλίκ σε Άμεσες Συνδρομές (με ένα κλίκ);")
    add("str_ensure_oneclick_handler", u"Πάντα να χρησιμοποιείται το CastPodder για άμεση (με ένα κλίκ) συνδρομή")
    ...
    add("str_donate", u"Δωρίστε στο CastPodder")
    add("str_donate_expl", u"Το CastPodder είναι ιδιοκτησία της παγκόσμιας κοινότητας των χρηστών του. Είναι σημαντικό να διατηρηθεί αυτός ο νέος τρόπος πρόσβασης σε μέσα επικοινωνίας ελεύθερος. Οποιοδήποτε χρηματικό ποσό θα έδινε χαρά και ενθάρρυνση στην ομάδα του CastPodder για την ανάπτυξη νέων λειτουργιών και υπηρεσιών.")
    ...
    add("str_gen_options_expl", u"Καθορισμός γενικών επιλογών για την εφαρμογή CastPodder")
    add("str_hide_on_startup", u"Στην εκκίνηση να εμφανίζεται το CastPodder στο Πλαίσιο Συστήματος")
    ...
    add("str_initialized", u"CastPodder έτοιμο")
    ...
    add("str_localization_restart", u"Για να μεταφραστούν όλα τα κουμπιά ελέγχου του CastPodder χρειάζεται επανεκκίνηση. Πατήστε Επιβεβαίωση για κλείσιμο, ή Άκυρο για συνέχεια.")
    ...
    # check for update
    add("str_new_version_ipodder", u"Υπάρχει μία νέα έκδοση του CastPodder, πατήστε Επιβεβαίωση για επίσκεψη στον ιστοχώρο κατεβάσματος.")
    add("str_no_new_version_ipodder", u"Αυτή η έκδοση του CastPodder είναι ενήμερη.")
    add("str_other_copy_running", u"Ένα άλλο αντίγραφο του CastPodder είναι ανοικτό. Παρακαλώ ανοίξτε το, περιμένετε να ολοκληρώσει, ή κλείστε το.")

    # Windows taskbar right-click menu
    add("str_check_now", u"Έλεγχος Τώρα")        
    add("str_open_ipodder", u"Άνοιγμα CastPodder")
    #--- Downloading
