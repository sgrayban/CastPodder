...
# -*- coding: utf-8 -*-
#
# $Id: ga.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_copy_location", u"Cóipeáil Suíomh")
    add("str_username", u"Ainm Úsáideora")
    add("str_password", u"Pasfhocal")
    ...
    add("str_yes", u"Yes")
    add("str_no", u"No")
    add("str_dont_ask", u"Ná cuir an ceist sin orm arís")
    add("str_ok", u"OK")
    ...
    add("str_days_old", u"lá roimh inniu")
    ...
    add("str_hours", u"uaireanta")
    add("str_minutes", u"nóiméid")
    ...
    add("str_ep_downloaded", u"Bailithe")
    add("str_ep_skipped_removed_other", u"Skipped/Removed/OtherFeed")
    add("str_ep_to_download", u"Chun Bailliú")

    add("str_select_none_cleanup", u"Select none")
    add("str_submit_lang", u"Cuir Teanga Isteach")
    ...
    add("str_dl_state_new", u"Nua")
    add("str_dl_state_queued", u"Queued")
    add("str_dl_state_downloading", u"Ag Bailiú")
    add("str_dl_state_downloaded", u"Bailithe")
    add("str_dl_state_cancelled", u"Cancelled")
    add("str_dl_state_finished", u"Déanta")
    ...
    add("str_lst_name", u"Ainm")
    add("str_lst_date", u"Dáta")        
