#! python
# -*- coding: utf-8 -*-
# $Id: hu.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
   ...
   add("str_donate", u"CastPodder támogatása")
   add("str_donate_expl", u"It's important to keep community-owned CastPodder applications online and keep this new way of consuming media free as in speech. A fejlesztõ csapat minden pénzt szívesen fogad, ami ösztönöz minket arra, hogy új funciókkal és szolgáltatásokkal bõvítsük a programot!")
   ...
   add("str_ep_to_download", u"Letöltésre")
   ...
   add("str_gen_options_expl", u"Végrehajtja az CastPodder általános beállításait")
   ...
   add("str_initialized", u"CastPodder kész")
   ...
   add("str_localization_restart", u"A nyelvváltás után az CastPoddert újra kell indítani. Kattints az OK gombra, ha leálítod, Mégsemre ha folytatni akarod az CastPodder használatát.")
   ...
   # check for update
   add("str_new_version_ipodder", u"Az CastPodder új verziója letölthetõ, kattints az OK gombra a letöltéshez.")
   add("str_no_new_version_ipodder", u"Nincs frissebb CastPodder verzió")
   add("str_other_copy_running", u"Az CastPodder már fut. Another copy of CastPodder is running. Várdd meg amíg befejezi vagy lõdd le!")

   # Windows taskbar right-click menu
   add("str_check_now", u"Adások keresése")
   add("str_open_ipodder", u"CastPodder megnyitása")
   #--- Downloading
