#! python
# -*- coding: utf-8 -*-
# $Id: pt-BR.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
   ...
   # The next 4 are for the status bar updates during the initial scan.
    ...
    add("str_ep_to_download", u"Para baixar")
    ...
    add("str_gen_options_expl", u"Ajusta as opções gerais para o programa CastPodder")
    add("str_hide_on_startup", u"Ao íniciar mostre somente o CastPodder no systray")
   ...
   # Advanced
    ...
    ## Donations Dialog
    #--- Doar para o CastPodder
    #--- É muito importante para manter o  CastPodder e suas aplicações online e não-comerciais e para manter este novo modelo de consumo de media livre. Qualquer quantia de dinheiro irá tornar a equipe mais feliz e encorajá-los no trabalho e desenvolvimento de melhorias!
    ...
    add("str_initialized", u"CastPodder aguardando")
    ...
    add("str_localization_restart", u"É necessário que o CastPodder seja re-iniciado. Clique Ok para terminar de forma limpa, cancelar para continuar.")
    ...
    ## check for update
    add("str_new_version_ipodder", u"Uma nova versão do CastPodder esta disponível, clique em  Ok e acesso o site de download.")
    add("str_no_new_version_ipodder", u"Esta versão é a mais recente")
    add("str_other_copy_running", u"Outra cópia do CastPodder está rodando. Pare-a, espere até estar completo, ou mate-a.")
