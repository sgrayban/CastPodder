#! python
# -*- coding: utf-8 -*-
# $Id: es.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_donate", u"Donar a CastPodder")
    add("str_donate_expl", u"Es importante mantener las aplicaciones de la comunidad CastPodder online y mantener esta nueva forma de transmitir contenidos multimedia. Cualquier aporte de dinero sera bien recibido por el equipo y los animara a trabajar en nuevas características y servicios!")
    ...
    add("str_gen_options_expl", u"Establecer las opciones generales para la aplicacion CastPodder")
    add("str_hide_on_startup", u"Mostrar CastPodder en la barra de herramientas al inicio")
    ...
    add("str_localization_restart", u"Para localizar todos los controles de CastPodder es necesario reiniciar. Haz click en ok para reiniciar, o en cancelar para continuar.")
    ...
    # check for update
    add("str_new_version_ipodder", u"Existe una nueva version de CastPodder disponible, haz click en Ok para ir a la pagina de descargas.")
    add("str_no_new_version_ipodder", u"This version of CastPodder is up to date")
    add("str_other_copy_running", u"CastPodder ya esta ejecutandose. Por favor, apagalo o espera a que acabe.")
