...
# -*- coding: utf-8 -*-
#
# $Id: fi.py 146 2006-11-07 07:44:29Z sgrayban $
#
...
def AddStrings(strtable):
    ...
    add("str_donate", u"Lahjoita rahaa CastPodderille")
    add("str_donate_expl", u"On tärkeää pitää yhteisön omistamia CastPodder-ohjelmia verkossa ja pitää yllä sananvapautta tässä uudessa tavassa kuluttaa mediaa . Mikä tahansa rahasumma tekee työryhmän onnelliseksi ja rohkaisee heitä työskentelemään uusien ominaisuuksien ja palvelujen parissa!")
    ...
    add("str_ep_to_download", u"Latausjonossa")
    ...
    add("str_gen_options_expl", u"CastPodder:in yleiset asetukset")
    add("str_hide_on_startup", u"Näytä CastPodder vain tehtäväpalkissa käynnistyttyä")
    ...
    ## Donations Dialog
    #--- Lahjoita CastPodderille
    #--- On tärkeää pitää yhteisön omistamia CastPodder-ohjelmia verkossa ja pitää yllä sananvapautta tässä uudessa tavassa kuluttaa mediaa . Mikä tahansa rahasumma tekee työryhmän onnelliseksi ja rohkaisee heitä työskentelemään uusien ominaisuuksien ja palvelujen parissa!
    ...
    add("str_initialized", u"CastPodder valmis")
    ...
    import gui.skin
    add("str_ipodder_title", gui.skin.PRODUCT_NAME + u" - Podcast-vastaanotin v" + __version__)
    ...
    # check for update
    add("str_new_version_ipodder", u"Uusi versio CastPodder:ista on saatavilla, paina Ok siirtyäksesi lataussivulle.")
    add("str_no_new_version_ipodder", u"Tämä versio CastPodderista on ajan tasalla.")
    add("str_other_copy_running", u"Toinen kopio CastPodderista on auki. Valitse se, odota sen valmistumista, tai lopeta se.")

    # Windows taskbar right-click menu
    add("str_check_now", u"Tarkista nyt")        
    add("str_open_ipodder", u"Avaa CastPodder")
    #--- Downloading
