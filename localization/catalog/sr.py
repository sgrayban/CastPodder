#! python
# -*- coding: utf-8 -*-
# $Id: sr.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_donate", "Donirajte CastPodder-u")
    add("str_donate_expl", "Vazno je odrzati CastPodder aplikacije koje su u vlasnistvu opste zajednice online i zadrzati ovaj novi nacin media besplatan kao sto je i govor. Svaki novcani iznos ce usreciti nas tim i podsteci ih da rade na daljem razvoju CastPodder-a.")
    ...
    add("str_ep_to_download", "Za download")
    ...
    add("str_gen_options_expl", "Postavi glavne osobine za CastPodder aplikaciju")
    add("str_hide_on_startup", "Prilikom pokretanja prikazi CastPodder samo kao sistemsku ikonu")
    ...
    add("str_initialized", "CastPodder je spreman")
    ...
    import gui.skin
    add("str_ipodder_title", gui.skin.PRODUCT_NAME + " - Podcast prijemnik v" + __version__)
    add("str_localization_restart", "Za lokalizovanje svih CastPodder kontrola potreban je restart. Klikni na Ok za zatvaranje, otkazi za nastavak.")
    ...
    add("str_other_copy_running", "Jos jedna kopija CastPodder-a je aktivna. Sacekaj dok zavrsi ili zaustavi proces.")

    # Windows taskbar right-click menu
    add("str_check_now","Provjeri sad")        
    add("str_open_ipodder","Otvori CastPodder")
    #--- Downloading
