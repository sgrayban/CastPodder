#! python
# -*- coding: utf-8 -*-
# $Id: pl.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_donate", u"Wspomórz CastPodder")
    add("str_donate_expl", u"Jest ważnym, by utrzymać program CastPodder przy życiu i tymsamym popierać wolność słowa w Internecie. Jakakolwiek kwota pieniędzy sprawi, że twórcy programu będa szczęśliwi i zdopingowani do pracy nad nowymi funkcjami programu!")
    ...
    add("str_ep_to_download", u"Do ściągnięcia")
    ...
    add("str_gen_options_expl", u"Ustaw ogólne opcje dla aplikacji CastPodder")
    add("str_hide_on_startup", u"Przy starcie pokazuj aplikacje CastPodder w pasku")
    ...
    add("str_initialized", u"CastPodder gotowy")
    ...
    add("str_localization_restart", u"By dostosować wszystkie opcje w programie CastPodder, wymagany jest restart aplikacji. Naciśnij Ok by zakończyć pracę aplikacji, lub Anuluj by kontynuować.")
    ...
    # check for update
    add("str_new_version_ipodder", u"Nowa wersja programu CastPodder jest dostępna, naciśnij Ok by przejść do strony producenta.")
    add("str_no_new_version_ipodder", u"Ta wersja aplikacji CastPodder jest najnowsza")
    add("str_other_copy_running", u"Inna sesja aplikacji CastPodder jest już uruchomiona. Przywołaj ją, poczekaj aż wykona wszystkie zadania, lub zamknij.")

    # Windows taskbar right-click menu
    add("str_check_now", u"Sprawdź teraz")        
    add("str_open_ipodder", u"Otwórz CastPodder")
    #--- Downloading
