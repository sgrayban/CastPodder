#! python
# -*- coding: utf-8 -*-
# $Id: nl.py 146 2006-11-07 07:44:29Z sgrayban $
...
def AddStrings(strtable):
    ...
    add("str_ep_to_download", "Klaar voor Download")
    ...
    add("str_gen_options_expl", "Algmeme opties voor de CastPodder applicatie")
    add("str_hide_on_startup", "Toon CastPodder alleen in de sytem tray bij een opstart")
    ...
    ## Donations Dialog
    add("str_donate", "Doneer CastPodder")
    add("str_donate_expl", "Het is belangrijk om de CastPodder applicatie publiekelijk te houden om deze manier van media consumptie ongebonden te houden. Elk bedrag dat u wilt doneren wordt zeer gewaardeerd door het team.")
    ...
    import gui.skin
    add("str_ipodder_title", "CastPodder - Podcast receiver v" + __version__)
    ...
    # check for update
    add("str_new_version_ipodder", "Een nieuwere versie van CastPodder is aanwezig, druk op Ok op naar de downloadpagina te gaan.")
    add("str_no_new_version_ipodder", "Deze versie van CastPodder is up-to-date!")
    ...
    add("str_open_ipodder","Open CastPodder")
    #--- Downloaden
