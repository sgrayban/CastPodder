...
I edited the original webbrowser.py because there was a issue
with CastPodder hanging until the browser was closed _IF_ it was started
by CastPodder. If the webbrowser was already running it didn't have this
problem. Scott Grayban
...
class GenericBrowser:
    ...
    def open(self, url, new=0, autoraise=1):
        assert "'" not in url
        command = "%s %s >/dev/null 2>&1 &" % (self.name, self.args)
